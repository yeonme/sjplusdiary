...
<body>
  <header class="ui fixed menu jb-header">
    <div class="jb-grid">
      ...
      <ul class="jb-nav">
        <li>
          <button class="ui inverted button jb-header-button">Logout</button>
        </li>
      </ul>
    </div>
  </header>
    ...
    <section class="ui fixed jb-sidebar">
      <div class="jb-sidebar-contents jb-profile">
        <div class="jb-profile-pic">
          ...
          <button class="ui inverted button jb-header-button">프로필
            <br/>수정</button>
        </div>
        <p class="jb-profile-desc">
          <span class="jb-profile-name jb-color-mint">이진백님</span>
      ...
      <div class="jb-sidebar-contents jb-calendar">
        ...
        <div class="jb-calendar-widget" style="background-color:white;">
